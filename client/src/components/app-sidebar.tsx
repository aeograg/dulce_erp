import { Home, Package, ClipboardList, DollarSign, FileText, Settings, LogOut, Wheat, Users } from "lucide-react";
...
const menuItems: MenuItem[] = [
  ...
  { title: "Recipes", url: "/recipes", icon: FileText, roles: ["Admin", "Manager"] },
